...
const std::string PATH_IMAGE_2 = "../front_end/res/image/IMG_2441.JPG";
const std::string PATH_IMAGE_3 = "../front_end/res/image/IMG_2452.JPG";
const std::string PATH_IMAGE_4 =
    "../front_end/res/image/IMG_20240506_150214_141.jpg";
const std::string PATH_IMAGE_5 = "../front_end/res/image/IMG_2442.jpg";
...
User_mode_t window_choose_mode() {
  ...
  // Создаем объект меню
  App::Menu my_menu(window, 720, 490, 180, 190, name_menu,
                    1);  //окно, координаты, размер шрифта, шаг, массив названий

  // Установка цвета отображения меню
  my_menu.set_color_text_menu(
      Color(220, 224, 244), Color(119, 132, 204),
...
int window_name_error(const std::string& error_text) {
  ...
  Texture texture_window;  // (***)
  if (!texture_window.loadFromFile(PATH_IMAGE_7)) {
    return 2;
  } 
  background.setTexture(&texture_window);
  ...
  init_text(error_message, 550, 350,
            error_text + "\n\n       Please put ESC \n\n       and try again",
            Ftext_e);  // 7000, 50 - позиция
...
User_city_t window_choose_city() {
  ...
  Texture texture_window;  // (***)
  if (!texture_window.loadFromFile(PATH_IMAGE_3)) {
    return user_city;
  }
  background.setTexture(&texture_window);
  ...
  // Создаем объект меню
  App::Menu my_menu(window, 950, 300, 100, 120, name_menu,
                    2);  //окно, координаты, размер шрифта, шаг, массив названий
...
size_t window_show_city(User_city_t user_city) {
  ...
  Texture texture_window;  // (***)
  if (!texture_window.loadFromFile(PATH_IMAGE_4)) {
    return change_city;
  }
  background.setTexture(&texture_window);
  ...
  // Создаем объект меню
  App::Menu my_menu(window, 960, 720, 120, 120, name_menu,
                    2);  //окно, координаты, размер шрифта, шаг, массив названий
...
int window_main(const std::vector<Weather_info>& arr) {
  ...
  // Создаем объект меню
  App::Menu my_menu(start_window, 950, 400, 140, 120, name_menu,
                    2);  //окно, координаты, размер шрифта, шаг, массив названий
